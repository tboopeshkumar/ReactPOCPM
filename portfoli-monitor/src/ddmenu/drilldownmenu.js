...
import './bootstrap.drilldown.css';
			...
			$.fn.drilldown = function (options) {
				...
				return this.each(function (options) {
					...
					function setUpDrilldown() {
						...
						var $arrow = '<span class="' + defaults.icon_class + '"></span>';
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-8">
						<br /><br />
						<div class="">
							<ul id="drilldown" className="drilldown">
								<li><a href="#">Live</a>
									<ul>
										<li><a href="#">HSLP</a>
											<ul>
												<li><a href="#/products/list">Profit &amp; Loss</a></li>
											</ul>
										</li>
									</ul>
								</li>
